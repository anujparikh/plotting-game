...
public class GraphicsFrame extends JFrame {
    ...
    public GraphicsFrame(GameState gameState, CommandAdapter adapter, int renderDelay, String frameTitle) {
        initFrame(gameState, renderDelay, adapter, frameTitle);
    }

    private void initFrame(GameState gameState, int renderDelay, CommandAdapter adapter, String frameTitle) {
