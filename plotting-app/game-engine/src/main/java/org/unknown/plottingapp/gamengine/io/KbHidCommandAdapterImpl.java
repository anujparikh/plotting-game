...
public class KbHidCommandAdapterImpl extends KeyAdapter implements CommandAdapter {

    private final GameState gameState;
    private final float turnRate;
    private final float acceleration;

    public KbHidCommandAdapterImpl(GameState gameState, float turnRate, float acceleration) {
